  ...
  return (
    <div className="border-0 lg:border border-gray_border lg:p-4 rounded-[20px] h-full">
      ...
      <div className="flex flex-col w-full">
        {/* Row 1 */}
        {isLoading ? (
          <div className="text-white flex justify-center items-center min-h-full lg:min-h-[200px] w-full">
            Loading...
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
            {
              ...
              data.tokens.slice(0, 8).map((item: any) => {
                return (
          ...
          <div className="text-white flex justify-center items-center lg:min-h-[200px] min-h-full w-full">
            No Assets Found{" "}
          </div>
        )}
      </div>
